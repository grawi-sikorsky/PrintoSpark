...
#define SLOWDOWN //printo spark dodane
...
#define MINIMUM_STEPPER_PULSE 0 // (µs) The smallest stepper pulse allowed //printospark dodane: było 0
...
#if ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 32 // SD,LCD,Buttons take more memory, block buffer needs to be smaller // 16 zdaje się powinno byc, 
#else
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_5 "Wylacz Drukarkę"
  #define USER_GCODE_5 "M810"
#endif
