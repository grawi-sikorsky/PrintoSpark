...
void homeaxis(const AxisEnum axis) {
	...
	set_galvo_pos(0, 0);  /***** Galvoworldpos set to 0,0; *****/
  ...
  // Clear retracted status if homing the Z axis
	...
	set_home_galvo();		/***** Galvoworldpos set to 0,0; *****/
	set_galvo_pos(0, 0);	/***** Galvoworldpos set to 0,0; TO SAMO O_O *****/
	move_galvos(0, 0);		/***** move x,y galvo (dacwrite->0); *****/
